...
public class ChineseNameGeneratorBase extends BaseGenericGenerator {
     ...
     */
    private static ChineseNameGeneratorBase instance = new ChineseNameGeneratorBase();

    private ChineseNameGeneratorBase() {
    }

    public static ChineseNameGeneratorBase getInstance() {
        return instance;
    }
