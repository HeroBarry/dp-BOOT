 ...
 * 3，将加法和加上校验位能被 10 整除。
 */
public class BankCardNumberGeneratorBase extends BaseGenericGenerator {
    private static BaseGenericGenerator instance = new BankCardNumberGeneratorBase();
    private BankCardNumberGeneratorBase() {
    }
