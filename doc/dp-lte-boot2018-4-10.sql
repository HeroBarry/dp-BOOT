...
Source Database       : dp-lte-boot

Target Server Type    : MYSQL
Target Server Version : 50619
File Encoding         : 65001

Date: 2018-04-10 01:04:06
*/
...
CREATE TABLE `b_visit` (
  ...
  `org_id` bigint(11) DEFAULT NULL COMMENT '部门id',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12270 DEFAULT CHARSET=utf8 COMMENT='来访登记';

-- ----------------------------
-- Records of b_visit
-- ----------------------------
INSERT INTO `b_visit` VALUES ('12266', '个', '地方', '的', '的', '4', '1', '的', 'jituan', '2018-04-09 21:52:31', '2018-04-09 23:25:12', null);
INSERT INTO `b_visit` VALUES ('12267', '想', '想', '想', '想', '4', '1', '想', 'jituan', '2018-04-09 23:25:00', null, null);
INSERT INTO `b_visit` VALUES ('12268', '在2', '在', '在', '在', '6', '20', '在', 'ranqisong', '2018-04-09 23:52:07', '2018-04-09 23:52:20', null);
INSERT INTO `b_visit` VALUES ('12269', '华通市场部', '华通市场部', '华通市场部', '华通市场部', '7', '24', '华通市场部', 'huatong001', '2018-04-09 23:57:28', null, null);
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('quartzScheduler', 'DESKTOP-OP4U4D31523289685427', '1523293221328', '15000');
...
CREATE TABLE `sys_client` (
  `name_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '姓名id',
  `shichang_id` int(11) DEFAULT NULL COMMENT '市场部id',
  `person` varchar(20) DEFAULT NULL COMMENT '责任人',
  `tel` varchar(20) NOT NULL COMMENT '电话',
  `sex` varchar(20) DEFAULT NULL COMMENT '性别',
  `weixin` varchar(30) DEFAULT NULL COMMENT '微信',
  `cus_leixin` varchar(50) DEFAULT NULL COMMENT '客户类型',
  `qudao` varchar(50) DEFAULT NULL COMMENT '来源渠道',
  `wenti` varchar(50) DEFAULT NULL COMMENT '顾虑问题',
  `zhuzhi` varchar(50) DEFAULT NULL COMMENT '住址',
  `chexing` varchar(10) DEFAULT NULL COMMENT '车型',
  `content` varchar(100) NOT NULL COMMENT '咨询内容',
  PRIMARY KEY (`name_id`)
...
-- ----------------------------
INSERT INTO `sys_client` VALUES ('1', '1', '6', '2', '2', '2', '2', '2', '2', '2', '2', '2');
INSERT INTO `sys_client` VALUES ('2', '1', '8', '3', '3', '3', '3', '3', '3', '3', '3', '3');
INSERT INTO `sys_client` VALUES ('4', '1', 'admin', '4', '4', '4', '4', '4', '4', '4', '4', '4');
...
CREATE TABLE `sys_log` (
  ...
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=312 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
INSERT INTO `sys_log` VALUES ('48', '-1', '获取用户信息为空', '登录', '243', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2017-12-18 15:18:21');
INSERT INTO `sys_log` VALUES ('49', '-1', '获取用户信息为空', '登录', '202', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2017-12-19 09:00:15');
INSERT INTO `sys_log` VALUES ('50', '1', 'admin', '新增菜单', '73', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":2,\"parentName\":\"系统菜单\",\"name\":\"来访登记\",\"url\":\"sys/dengji\",\"perms\":\"user:list,user:add,user:create\",\"type\":1,\"icon\":\"fa fa-address-card-o\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 09:32:02');
INSERT INTO `sys_log` VALUES ('51', '1', 'admin', '新增菜单', '25', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":1,\"parentName\":\"系统管理\",\"name\":\"来访登记\",\"url\":\"sys/dengji\",\"perms\":\"user:list,user:create,user:add\",\"type\":1,\"icon\":\"fa fa-user-circle\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 09:34:39');
INSERT INTO `sys_log` VALUES ('52', '1', 'admin', '删除菜单', '109', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[69]', '0:0:0:0:0:0:0:1', '2017-12-19 09:35:21');
INSERT INTO `sys_log` VALUES ('53', '1', 'admin', '新增菜单', '47', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":0,\"parentName\":\"一级菜单\",\"name\":\"来访登记\",\"url\":null,\"perms\":null,\"type\":0,\"icon\":\"fa fa-user-circle\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 10:56:54');
INSERT INTO `sys_log` VALUES ('54', '1', 'admin', '删除菜单', '41', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[76]', '0:0:0:0:0:0:0:1', '2017-12-19 10:57:50');
INSERT INTO `sys_log` VALUES ('55', '1', 'admin', '新增菜单', '29', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":0,\"parentName\":\"一级菜单\",\"name\":\"来访登记\",\"url\":null,\"perms\":null,\"type\":0,\"icon\":\"fa fa-address-book\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 10:59:44');
INSERT INTO `sys_log` VALUES ('56', '1', 'admin', '操作权限', '92', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,37,38,39,40,41,70,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:00:21');
INSERT INTO `sys_log` VALUES ('57', '1', 'admin', '新增菜单', '28', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":77,\"parentName\":\"来访登记\",\"name\":\"来访人员\",\"url\":\"base/dengji\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-id-badge\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:04:31');
INSERT INTO `sys_log` VALUES ('58', '1', 'admin', '新增菜单', '27', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":78,\"parentName\":\"来访人员\",\"name\":\"来访列表\",\"url\":\"base/dengji\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-address-card\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:06:11');
INSERT INTO `sys_log` VALUES ('59', '1', 'admin', '新增菜单', '27', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":79,\"parentName\":\"来访列表\",\"name\":\"增加\",\"url\":null,\"perms\":\"user:list,user:create,user:add\",\"type\":2,\"icon\":null,\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:07:20');
INSERT INTO `sys_log` VALUES ('60', '1', 'admin', '新增菜单', '24', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":79,\"parentName\":\"来访列表\",\"name\":\"删除\",\"url\":null,\"perms\":\"user:list,user:delete\",\"type\":2,\"icon\":null,\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:09:11');
INSERT INTO `sys_log` VALUES ('61', '1', 'admin', '新增菜单', '33', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":79,\"parentName\":\"来访列表\",\"name\":\"编辑\",\"url\":null,\"perms\":\"user:update,user:list\",\"type\":2,\"icon\":null,\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:10:08');
INSERT INTO `sys_log` VALUES ('62', '1', 'admin', '新增菜单', '34', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":79,\"parentName\":\"来访列表\",\"name\":\"查询\",\"url\":null,\"perms\":\"user:list\",\"type\":2,\"icon\":null,\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:12:08');
INSERT INTO `sys_log` VALUES ('63', '1', 'admin', '修改菜单', '41', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":80,\"parentId\":79,\"parentName\":\"来访列表\",\"name\":\"增加\",\"url\":null,\"perms\":\"user:list,user:create,user:add\",\"type\":2,\"icon\":null,\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:12:54');
INSERT INTO `sys_log` VALUES ('64', '1', 'admin', '操作权限', '83', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,37,38,39,40,41,70,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:15:41');
INSERT INTO `sys_log` VALUES ('65', '1', 'admin', '操作权限', '120', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,70,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:20:15');
INSERT INTO `sys_log` VALUES ('66', '1', 'admin', '修改菜单', '28', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":78,\"parentId\":77,\"parentName\":\"来访登记\",\"name\":\"来访人员\",\"url\":\"base/dengji/list.html\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-id-badge\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:20:53');
INSERT INTO `sys_log` VALUES ('67', '1', 'admin', '修改菜单', '36', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":78,\"parentId\":77,\"parentName\":\"来访登记\",\"name\":\"来访人员\",\"url\":\"base/list.html\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-id-badge\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:25:23');
INSERT INTO `sys_log` VALUES ('68', '1', 'admin', '修改菜单', '27', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":79,\"parentId\":78,\"parentName\":\"来访人员\",\"name\":\"来访列表\",\"url\":\"base/\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-address-card\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:25:46');
INSERT INTO `sys_log` VALUES ('69', '1', 'admin', '修改菜单', '47', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":79,\"parentId\":78,\"parentName\":\"来访人员\",\"name\":\"来访列表\",\"url\":\"base/list.html\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-address-card\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:30:29');
INSERT INTO `sys_log` VALUES ('70', '1', 'admin', '修改菜单', '40', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":80,\"parentId\":79,\"parentName\":\"来访列表\",\"name\":\"增加\",\"url\":null,\"perms\":\"user:list,user:create,user:add\",\"type\":2,\"icon\":null,\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:30:57');
INSERT INTO `sys_log` VALUES ('71', '1', 'admin', '修改菜单', '24', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":77,\"parentId\":0,\"parentName\":\"一级菜单\",\"name\":\"来访登记\",\"url\":null,\"perms\":null,\"type\":0,\"icon\":\"fa fa-address-book\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:35:53');
INSERT INTO `sys_log` VALUES ('72', '1', 'admin', '修改菜单', '21', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":78,\"parentId\":77,\"parentName\":\"来访登记\",\"name\":\"来访人员\",\"url\":\"base/list.html\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-id-badge\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:36:50');
INSERT INTO `sys_log` VALUES ('73', '1', 'admin', '修改菜单', '29', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":78,\"parentId\":77,\"parentName\":\"来访登记\",\"name\":\"来访人员\",\"url\":\"base/customer/list.html\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-id-badge\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:38:54');
INSERT INTO `sys_log` VALUES ('74', '1', 'admin', '修改菜单', '51', 'net.chenlin.dp.modules.sys.controller.SysMenuController.update()', '{\"menuId\":79,\"parentId\":78,\"parentName\":\"来访人员\",\"name\":\"来访列表\",\"url\":\"base/customer/list.html\",\"perms\":\"user:list,user:create\",\"type\":1,\"icon\":\"fa fa-address-card\",\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:39:19');
INSERT INTO `sys_log` VALUES ('75', '1', 'admin', '操作权限', '87', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,70,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 11:45:15');
INSERT INTO `sys_log` VALUES ('76', '1', 'admin', '操作权限', '216', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 14:25:01');
INSERT INTO `sys_log` VALUES ('77', '1', 'admin', '数据权限', '240', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":39,\"orgId\":3,\"orgName\":\"高淳区\",\"roleName\":\"测试用户\",\"roleSign\":\"test\",\"remark\":null,\"userIdCreate\":null,\"menuIdList\":[],\"orgIdList\":[3],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 14:40:43');
INSERT INTO `sys_log` VALUES ('78', '1', 'admin', '新增菜单', '124', 'net.chenlin.dp.modules.sys.controller.SysMenuController.save()', '{\"menuId\":null,\"parentId\":79,\"parentName\":\"来访列表\",\"name\":\"查询所有\",\"url\":null,\"perms\":\"laifang:all\",\"type\":2,\"icon\":null,\"orderNum\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 16:38:09');
INSERT INTO `sys_log` VALUES ('79', '1', 'admin', '操作权限', '231', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,84,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-19 17:08:14');
INSERT INTO `sys_log` VALUES ('80', '-1', '获取用户信息为空', '登录', '214', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2017-12-20 13:16:10');
INSERT INTO `sys_log` VALUES ('81', '1', 'admin', '新增客户信息', '29', 'net.chenlin.dp.modules.sys.controller.SysClientController.save()', '{\"nameId\":0,\"shichangId\":1,\"person\":\"admin\",\"tel\":\"2\",\"sex\":\"2\",\"weixin\":\"2\",\"cusLeixin\":\"2\",\"qudao\":\"2\",\"wenti\":\"2\",\"zhuzhi\":\"2\",\"chexing\":\"2\",\"content\":\"2\"}', '0:0:0:0:0:0:0:1', '2017-12-20 13:16:43');
INSERT INTO `sys_log` VALUES ('82', '1', 'admin', '新增客户信息', '40', 'net.chenlin.dp.modules.sys.controller.SysClientController.save()', '{\"nameId\":0,\"shichangId\":1,\"person\":\"admin\",\"tel\":\"3\",\"sex\":\"3\",\"weixin\":\"3\",\"cusLeixin\":\"3\",\"qudao\":\"3\",\"wenti\":\"3\",\"zhuzhi\":\"3\",\"chexing\":\"3\",\"content\":\"3\"}', '0:0:0:0:0:0:0:1', '2017-12-20 13:17:17');
INSERT INTO `sys_log` VALUES ('83', '1', 'admin', '修改客户信息', '26', 'net.chenlin.dp.modules.sys.controller.SysClientController.update()', '{\"nameId\":1,\"shichangId\":1,\"person\":\"6\",\"tel\":\"2\",\"sex\":\"2\",\"weixin\":\"2\",\"cusLeixin\":\"2\",\"qudao\":\"2\",\"wenti\":\"2\",\"zhuzhi\":\"2\",\"chexing\":\"2\",\"content\":\"2\"}', '0:0:0:0:0:0:0:1', '2017-12-20 13:18:05');
INSERT INTO `sys_log` VALUES ('84', '1', 'admin', '新增客户信息', '44', 'net.chenlin.dp.modules.sys.controller.SysClientController.save()', '{\"nameId\":0,\"shichangId\":1,\"person\":\"admin\",\"tel\":\"3\",\"sex\":\"3\",\"weixin\":\"3\",\"cusLeixin\":\"3\",\"qudao\":\"33\",\"wenti\":\"3\",\"zhuzhi\":\"3\",\"chexing\":\"3\",\"content\":\"3\"}', '0:0:0:0:0:0:0:1', '2017-12-20 13:18:31');
INSERT INTO `sys_log` VALUES ('85', '1', 'admin', '修改客户信息', '37', 'net.chenlin.dp.modules.sys.controller.SysClientController.update()', '{\"nameId\":2,\"shichangId\":1,\"person\":\"8\",\"tel\":\"3\",\"sex\":\"3\",\"weixin\":\"3\",\"cusLeixin\":\"3\",\"qudao\":\"3\",\"wenti\":\"3\",\"zhuzhi\":\"3\",\"chexing\":\"3\",\"content\":\"3\"}', '0:0:0:0:0:0:0:1', '2017-12-20 13:18:46');
INSERT INTO `sys_log` VALUES ('86', '1', 'admin', '数据权限', '84', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,84,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-20 13:19:39');
INSERT INTO `sys_log` VALUES ('87', '1', 'admin', '操作权限', '84', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,84,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-20 13:20:02');
INSERT INTO `sys_log` VALUES ('88', '1', 'admin', '操作权限', '30', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":39,\"orgId\":3,\"orgName\":\"高淳区\",\"roleName\":\"测试用户\",\"roleSign\":\"test\",\"remark\":null,\"userIdCreate\":null,\"menuIdList\":[1,70,77,78,79,84],\"orgIdList\":[3],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-20 13:21:06');
INSERT INTO `sys_log` VALUES ('89', '1', 'admin', '新增用户', '59', 'net.chenlin.dp.modules.sys.controller.SysUserController.save()', '{\"userId\":2,\"orgId\":1,\"orgName\":\"江苏省\",\"username\":\"2\",\"password\":\"7fe81961d0b10fc534f43be1872a9448\",\"email\":\"222\",\"mobile\":\"22\",\"status\":1,\"userIdCreate\":1,\"remark\":\"22\",\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[39]}', '0:0:0:0:0:0:0:1', '2017-12-20 13:22:19');
INSERT INTO `sys_log` VALUES ('90', '1', 'admin', '新增用户', '81', 'net.chenlin.dp.modules.sys.controller.SysUserController.save()', '{\"userId\":3,\"orgId\":2,\"orgName\":\"南京市\",\"username\":\"22\",\"password\":\"f3fd219f1c9546f282c772f11060db64\",\"email\":\"99\",\"mobile\":\"999\",\"status\":1,\"userIdCreate\":1,\"remark\":\"999\",\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[39]}', '0:0:0:0:0:0:0:1', '2017-12-20 13:22:43');
INSERT INTO `sys_log` VALUES ('91', '1', 'admin', '新增客户信息', '35', 'net.chenlin.dp.modules.sys.controller.SysClientController.save()', '{\"nameId\":0,\"shichangId\":1,\"person\":\"admin\",\"tel\":\"4\",\"sex\":\"4\",\"weixin\":\"4\",\"cusLeixin\":\"4\",\"qudao\":\"4\",\"wenti\":\"4\",\"zhuzhi\":\"4\",\"chexing\":\"4\",\"content\":\"4\"}', '0:0:0:0:0:0:0:1', '2017-12-20 13:23:21');
INSERT INTO `sys_log` VALUES ('92', '1', 'admin', '删除客户信息', '30', 'net.chenlin.dp.modules.sys.controller.SysClientController.batchRemove()', '[3]', '0:0:0:0:0:0:0:1', '2017-12-20 13:23:52');
INSERT INTO `sys_log` VALUES ('93', '1', 'admin', '数据权限', '51', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":39,\"orgId\":3,\"orgName\":\"高淳区\",\"roleName\":\"测试用户\",\"roleSign\":\"test\",\"remark\":null,\"userIdCreate\":null,\"menuIdList\":[1,70,77,78,79,84],\"orgIdList\":[2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-20 13:24:26');
INSERT INTO `sys_log` VALUES ('94', '1', 'admin', '数据权限', '112', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"江苏省\",\"roleName\":\"超级管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,84,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2017-12-20 13:24:39');
INSERT INTO `sys_log` VALUES ('95', '-1', '获取用户信息为空', '登录', '270', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-01-04 19:35:20');
INSERT INTO `sys_log` VALUES ('96', '-1', '获取用户信息为空', '登录', '410', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-01-05 10:06:13');
INSERT INTO `sys_log` VALUES ('97', '1', 'admin', '修改机构', '54', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":1,\"parentId\":0,\"parentName\":null,\"code\":\"js\",\"name\":\"壹鹿集团\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:07:18');
INSERT INTO `sys_log` VALUES ('98', '1', 'admin', '修改机构', '32', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":2,\"parentId\":1,\"parentName\":\"壹鹿集团\",\"code\":\"nj\",\"name\":\"一路驾校\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:07:35');
INSERT INTO `sys_log` VALUES ('99', '1', 'admin', '新增机构', '32', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":1,\"parentName\":\"壹鹿集团\",\"code\":\"huatong\",\"name\":\"华通驾校\",\"orderNum\":1,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:08:09');
INSERT INTO `sys_log` VALUES ('100', '1', 'admin', '修改机构', '40', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":3,\"parentId\":2,\"parentName\":\"一路驾校\",\"code\":\"gc\",\"name\":\"市场部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:08:30');
INSERT INTO `sys_log` VALUES ('101', '1', 'admin', '新增机构', '34', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":2,\"parentName\":\"一路驾校\",\"code\":\"peixun\",\"name\":\"培训部\",\"orderNum\":1,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:09:04');
INSERT INTO `sys_log` VALUES ('102', '1', 'admin', '新增机构', '28', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":2,\"parentName\":\"一路驾校\",\"code\":\"xingzheng\",\"name\":\"行政人力\",\"orderNum\":2,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:09:41');
INSERT INTO `sys_log` VALUES ('103', '1', 'admin', '修改机构', '22', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":4,\"parentId\":3,\"parentName\":\"市场部\",\"code\":\"syxx\",\"name\":\"市场一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:10:02');
INSERT INTO `sys_log` VALUES ('104', '1', 'admin', '新增机构', '33', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":18,\"parentName\":\"培训部\",\"code\":\"peixuni\",\"name\":\"培训一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:10:34');
INSERT INTO `sys_log` VALUES ('105', '1', 'admin', '修改角色', '21', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRole()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"roleName\":\"系统管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置：开发者使用】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,84,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:14:06');
INSERT INTO `sys_log` VALUES ('106', '1', 'admin', '修改角色', '54', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRole()', '{\"roleId\":39,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"roleName\":\"集团CEO\",\"roleSign\":\"CEO\",\"remark\":\"集团老板\",\"userIdCreate\":null,\"menuIdList\":[1,70,77,78,79,84],\"orgIdList\":[2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:14:46');
INSERT INTO `sys_log` VALUES ('107', '1', 'admin', '新增角色', '21', 'net.chenlin.dp.modules.sys.controller.SysRoleController.saveRole()', '{\"roleId\":null,\"orgId\":17,\"orgName\":\"华通驾校\",\"roleName\":\"华通驾校CEO\",\"roleSign\":\"ht-ceo\",\"remark\":\"华通驾校老大\",\"userIdCreate\":1,\"menuIdList\":null,\"orgIdList\":null,\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:15:39');
INSERT INTO `sys_log` VALUES ('108', '1', 'admin', '新增角色', '36', 'net.chenlin.dp.modules.sys.controller.SysRoleController.saveRole()', '{\"roleId\":null,\"orgId\":2,\"orgName\":\"一路驾校\",\"roleName\":\"一路驾校CEO\",\"roleSign\":\"ylu-ceo\",\"remark\":\"一路驾校老大\",\"userIdCreate\":1,\"menuIdList\":null,\"orgIdList\":null,\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-01-05 10:16:21');
INSERT INTO `sys_log` VALUES ('109', '-1', '获取用户信息为空', '登录', '158', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-01-06 09:15:54');
INSERT INTO `sys_log` VALUES ('110', '-1', '获取用户信息为空', '登录', '1686', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-01-11 14:17:29');
INSERT INTO `sys_log` VALUES ('111', '-1', '获取用户信息为空', '登录', '62', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-01-11 14:17:30');
INSERT INTO `sys_log` VALUES ('112', '-1', '获取用户信息为空', '登录', '398', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-02-10 10:37:49');
INSERT INTO `sys_log` VALUES ('113', '-1', '获取用户信息为空', '登录', '358', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-04-09 17:33:28');
INSERT INTO `sys_log` VALUES ('114', '-1', '获取用户信息为空', '登录', '69', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-04-09 17:33:28');
INSERT INTO `sys_log` VALUES ('115', '-1', '获取用户信息为空', '登录', '71', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-04-09 17:33:31');
INSERT INTO `sys_log` VALUES ('116', '1', 'admin', '删除菜单', '3', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[77]', '0:0:0:0:0:0:0:1', '2018-04-09 19:45:11');
INSERT INTO `sys_log` VALUES ('117', '1', 'admin', '删除菜单', '2', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[79]', '0:0:0:0:0:0:0:1', '2018-04-09 19:45:22');
INSERT INTO `sys_log` VALUES ('118', '1', 'admin', '删除菜单', '3', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[79]', '0:0:0:0:0:0:0:1', '2018-04-09 19:45:55');
INSERT INTO `sys_log` VALUES ('119', '1', 'admin', '操作权限', '300', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"roleName\":\"系统管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置：开发者使用】\",\"userIdCreate\":null,\"menuIdList\":[1,71,72,73,74,75,90,91,92,93,94,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,77,78,79,80,81,82,83,84,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 19:47:17');
INSERT INTO `sys_log` VALUES ('120', '1', 'admin', '新增来访登记', '74', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"dfgkj\",\"content\":\"fdgd\",\"mobile\":\"dfgfd\",\"contactAddress\":\"dfff\",\"orgId\":1,\"remarks\":\"fdff\",\"operator\":\"admin\",\"createTime\":1523275535757,\"updateTime\":null,\"deleteTime\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:05:35');
INSERT INTO `sys_log` VALUES ('121', '1', 'admin', '新增机构', '59', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":17,\"parentName\":\"华通驾校\",\"code\":\"ht-scb\",\"name\":\"市场部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:40:38');
INSERT INTO `sys_log` VALUES ('122', '1', 'admin', '新增机构', '43', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":17,\"parentName\":\"华通驾校\",\"code\":\"ht-pxb\",\"name\":\"培训部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:41:05');
INSERT INTO `sys_log` VALUES ('123', '1', 'admin', '新增机构', '26', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":17,\"parentName\":\"华通驾校\",\"code\":\"ht-xzrl\",\"name\":\"行政人力\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:41:40');
INSERT INTO `sys_log` VALUES ('124', '1', 'admin', '新增机构', '53', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":21,\"parentName\":\"市场部\",\"code\":\"ht-scb-001\",\"name\":\"市场一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:42:17');
INSERT INTO `sys_log` VALUES ('125', '1', 'admin', '新增机构', '26', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":21,\"parentName\":\"市场部\",\"code\":\"ht-scb-002\",\"name\":\"市场二部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:42:50');
INSERT INTO `sys_log` VALUES ('126', '1', 'admin', '修改机构', '26', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":1,\"parentId\":0,\"parentName\":null,\"code\":\"yljt\",\"name\":\"壹鹿集团\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:45:14');
INSERT INTO `sys_log` VALUES ('127', '1', 'admin', '修改机构', '26', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":2,\"parentId\":1,\"parentName\":\"壹鹿集团\",\"code\":\"yilu\",\"name\":\"壹路驾校\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:45:39');
INSERT INTO `sys_log` VALUES ('128', '1', 'admin', '删除机构', '3', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[5]', '0:0:0:0:0:0:0:1', '2018-04-09 20:45:53');
INSERT INTO `sys_log` VALUES ('129', '1', 'admin', '删除机构', '79', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[10]', '0:0:0:0:0:0:0:1', '2018-04-09 20:46:01');
INSERT INTO `sys_log` VALUES ('130', '1', 'admin', '删除机构', '38', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[9]', '0:0:0:0:0:0:0:1', '2018-04-09 20:46:11');
INSERT INTO `sys_log` VALUES ('131', '1', 'admin', '删除机构', '32', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[5]', '0:0:0:0:0:0:0:1', '2018-04-09 20:46:20');
INSERT INTO `sys_log` VALUES ('132', '1', 'admin', '删除机构', '24', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[11]', '0:0:0:0:0:0:0:1', '2018-04-09 20:46:30');
INSERT INTO `sys_log` VALUES ('133', '1', 'admin', '删除机构', '29', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[12]', '0:0:0:0:0:0:0:1', '2018-04-09 20:46:39');
INSERT INTO `sys_log` VALUES ('134', '1', 'admin', '删除机构', '32', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[13]', '0:0:0:0:0:0:0:1', '2018-04-09 20:46:46');
INSERT INTO `sys_log` VALUES ('135', '1', 'admin', '删除机构', '29', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[6]', '0:0:0:0:0:0:0:1', '2018-04-09 20:46:54');
INSERT INTO `sys_log` VALUES ('136', '1', 'admin', '删除机构', '32', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[14]', '0:0:0:0:0:0:0:1', '2018-04-09 20:47:03');
INSERT INTO `sys_log` VALUES ('137', '1', 'admin', '删除机构', '31', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[15]', '0:0:0:0:0:0:0:1', '2018-04-09 20:47:12');
INSERT INTO `sys_log` VALUES ('138', '1', 'admin', '删除机构', '30', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[16]', '0:0:0:0:0:0:0:1', '2018-04-09 20:47:22');
INSERT INTO `sys_log` VALUES ('139', '1', 'admin', '删除机构', '26', 'net.chenlin.dp.modules.sys.controller.SysOrgController.batchRemove()', '[7]', '0:0:0:0:0:0:0:1', '2018-04-09 20:47:30');
INSERT INTO `sys_log` VALUES ('140', '1', 'admin', '修改机构', '25', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":3,\"parentId\":2,\"parentName\":\"壹路驾校\",\"code\":\"yl-scb\",\"name\":\"市场部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:47:54');
INSERT INTO `sys_log` VALUES ('141', '1', 'admin', '修改机构', '33', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":4,\"parentId\":3,\"parentName\":\"市场部\",\"code\":\"yl-scb-001\",\"name\":\"市场一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:48:14');
INSERT INTO `sys_log` VALUES ('142', '1', 'admin', '修改机构', '35', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":18,\"parentId\":2,\"parentName\":\"壹路驾校\",\"code\":\"yl-pxb\",\"name\":\"培训部\",\"orderNum\":1,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:48:38');
INSERT INTO `sys_log` VALUES ('143', '1', 'admin', '修改机构', '31', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":20,\"parentId\":18,\"parentName\":\"培训部\",\"code\":\"yl-pxb-001\",\"name\":\"培训一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:49:01');
INSERT INTO `sys_log` VALUES ('144', '1', 'admin', '修改机构', '26', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":19,\"parentId\":2,\"parentName\":\"壹路驾校\",\"code\":\"yl-xzrl\",\"name\":\"行政人力\",\"orderNum\":2,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 20:49:24');
INSERT INTO `sys_log` VALUES ('145', '1', 'admin', '修改用户', '94', 'net.chenlin.dp.modules.sys.controller.SysUserController.update()', '{\"userId\":2,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"username\":\"yilu\",\"password\":\"7fe81961d0b10fc534f43be1872a9448\",\"email\":\"222\",\"mobile\":\"22\",\"status\":1,\"userIdCreate\":null,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[39]}', '0:0:0:0:0:0:0:1', '2018-04-09 20:50:34');
INSERT INTO `sys_log` VALUES ('146', '1', 'admin', '修改用户', '113', 'net.chenlin.dp.modules.sys.controller.SysUserController.update()', '{\"userId\":2,\"orgId\":2,\"orgName\":\"壹路驾校\",\"username\":\"yilu\",\"password\":\"7fe81961d0b10fc534f43be1872a9448\",\"email\":\"222\",\"mobile\":\"22\",\"status\":1,\"userIdCreate\":null,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[41]}', '0:0:0:0:0:0:0:1', '2018-04-09 20:51:29');
INSERT INTO `sys_log` VALUES ('147', '1', 'admin', '修改用户', '81', 'net.chenlin.dp.modules.sys.controller.SysUserController.update()', '{\"userId\":3,\"orgId\":17,\"orgName\":\"华通驾校\",\"username\":\"huatong\",\"password\":\"f3fd219f1c9546f282c772f11060db64\",\"email\":\"99\",\"mobile\":\"999\",\"status\":1,\"userIdCreate\":null,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[40]}', '0:0:0:0:0:0:0:1', '2018-04-09 20:51:58');
INSERT INTO `sys_log` VALUES ('148', '1', 'admin', '新增用户', '97', 'net.chenlin.dp.modules.sys.controller.SysUserController.save()', '{\"userId\":4,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"username\":\"jituan\",\"password\":\"0ca0b429b8956d62956aee483de87095\",\"email\":null,\"mobile\":null,\"status\":1,\"userIdCreate\":1,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[39]}', '0:0:0:0:0:0:0:1', '2018-04-09 20:52:41');
INSERT INTO `sys_log` VALUES ('149', '-1', '获取用户信息为空', '登录', '150', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 20:57:55');
INSERT INTO `sys_log` VALUES ('150', '-1', '获取用户信息为空', '登录', '29', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 20:58:31');
INSERT INTO `sys_log` VALUES ('151', '1', 'admin', '新增来访登记', '43', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"aaa\",\"content\":\"1213\",\"mobile\":\"12312\",\"contactAddress\":\"312321312\",\"orgId\":1,\"userId\":1,\"remarks\":\"312312\",\"operator\":\"admin\",\"createTime\":1523278815158,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.74', '2018-04-09 21:00:15');
INSERT INTO `sys_log` VALUES ('152', '1', 'admin', '删除来访登记', '83', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12251]', '192.168.1.74', '2018-04-09 21:00:21');
INSERT INTO `sys_log` VALUES ('153', '1', 'admin', '新增来访登记', '22', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"123\",\"content\":\"12312\",\"mobile\":\"3123\",\"contactAddress\":\"123\",\"orgId\":1,\"userId\":1,\"remarks\":\"123\",\"operator\":\"admin\",\"createTime\":1523278833954,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.74', '2018-04-09 21:00:33');
INSERT INTO `sys_log` VALUES ('154', '1', 'admin', '新增来访登记', '52', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"admin\",\"content\":\"admin\",\"mobile\":\"1231231\",\"contactAddress\":\"23123\",\"orgId\":1,\"userId\":1,\"remarks\":\"123123\",\"operator\":\"admin\",\"createTime\":1523278991965,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.74', '2018-04-09 21:03:12');
INSERT INTO `sys_log` VALUES ('155', '1', 'admin', '新增用户', '240', 'net.chenlin.dp.modules.sys.controller.SysUserController.save()', '{\"userId\":5,\"orgId\":4,\"orgName\":\"市场一部\",\"username\":\"xiaoran\",\"password\":\"706c728377e459a36c96c29c95d0c44f\",\"email\":\"12312\",\"mobile\":\"13456789012\",\"status\":0,\"userIdCreate\":1,\"remark\":\"312312\",\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[1]}', '192.168.1.74', '2018-04-09 21:05:00');
INSERT INTO `sys_log` VALUES ('156', '1', 'admin', '启用账户', '69', 'net.chenlin.dp.modules.sys.controller.SysUserController.updateUserEnable()', '[5]', '192.168.1.74', '2018-04-09 21:05:08');
INSERT INTO `sys_log` VALUES ('157', '1', 'admin', '新增角色', '26', 'net.chenlin.dp.modules.sys.controller.SysRoleController.saveRole()', '{\"roleId\":null,\"orgId\":18,\"orgName\":\"培训部\",\"roleName\":\"培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":1,\"menuIdList\":null,\"orgIdList\":null,\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.74', '2018-04-09 21:06:18');
INSERT INTO `sys_log` VALUES ('158', '1', 'admin', '修改用户', '75', 'net.chenlin.dp.modules.sys.controller.SysUserController.update()', '{\"userId\":5,\"orgId\":4,\"orgName\":\"市场一部\",\"username\":\"xiaoran\",\"password\":\"706c728377e459a36c96c29c95d0c44f\",\"email\":\"12312\",\"mobile\":\"13456789012\",\"status\":1,\"userIdCreate\":null,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[42]}', '192.168.1.74', '2018-04-09 21:06:31');
INSERT INTO `sys_log` VALUES ('159', '1', 'admin', '新增用户', '52', 'net.chenlin.dp.modules.sys.controller.SysUserController.save()', '{\"userId\":6,\"orgId\":20,\"orgName\":\"培训一部\",\"username\":\"ranqisong\",\"password\":\"d6c50fe8157f75f958b9bc8709fde17b\",\"email\":\"123\",\"mobile\":\"12345678901\",\"status\":0,\"userIdCreate\":1,\"remark\":\"12312312\",\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[42]}', '192.168.1.74', '2018-04-09 21:07:43');
INSERT INTO `sys_log` VALUES ('160', '-1', null, '退出系统', '113', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:08:29');
INSERT INTO `sys_log` VALUES ('161', '-1', '获取用户信息为空', '登录', '2', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:08:38');
INSERT INTO `sys_log` VALUES ('162', '-1', '获取用户信息为空', '登录', '3', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:08:39');
INSERT INTO `sys_log` VALUES ('163', '-1', '获取用户信息为空', '登录', '2', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:08:40');
INSERT INTO `sys_log` VALUES ('164', '-1', '获取用户信息为空', '登录', '2', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:08:40');
INSERT INTO `sys_log` VALUES ('165', '-1', '获取用户信息为空', '登录', '2', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:08:40');
INSERT INTO `sys_log` VALUES ('166', '-1', '获取用户信息为空', '登录', '37', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:08:43');
INSERT INTO `sys_log` VALUES ('167', '1', 'admin', '删除菜单', '40', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[86]', '192.168.1.74', '2018-04-09 21:12:03');
INSERT INTO `sys_log` VALUES ('168', '1', 'admin', '修改用户', '120', 'net.chenlin.dp.modules.sys.controller.SysUserController.update()', '{\"userId\":4,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"username\":\"jituan\",\"password\":\"0ca0b429b8956d62956aee483de87095\",\"email\":null,\"mobile\":null,\"status\":1,\"userIdCreate\":null,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[1]}', '192.168.1.74', '2018-04-09 21:12:47');
INSERT INTO `sys_log` VALUES ('169', '-1', '获取用户信息为空', '登录', '66', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"jituan\"', '192.168.1.75', '2018-04-09 21:13:16');
INSERT INTO `sys_log` VALUES ('170', '1', 'admin', '启用账户', '22', 'net.chenlin.dp.modules.sys.controller.SysUserController.updateUserEnable()', '[6]', '192.168.1.74', '2018-04-09 21:13:19');
INSERT INTO `sys_log` VALUES ('171', '4', 'jituan', '删除菜单', '35', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[89]', '192.168.1.75', '2018-04-09 21:13:29');
INSERT INTO `sys_log` VALUES ('172', '1', 'admin', '修改用户', '104', 'net.chenlin.dp.modules.sys.controller.SysUserController.update()', '{\"userId\":6,\"orgId\":20,\"orgName\":\"培训一部\",\"username\":\"ranqisong\",\"password\":\"d6c50fe8157f75f958b9bc8709fde17b\",\"email\":\"123\",\"mobile\":\"12345678901\",\"status\":0,\"userIdCreate\":null,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[42]}', '192.168.1.74', '2018-04-09 21:13:34');
INSERT INTO `sys_log` VALUES ('173', '4', 'jituan', '删除菜单', '35', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[88]', '192.168.1.75', '2018-04-09 21:13:37');
INSERT INTO `sys_log` VALUES ('174', '4', 'jituan', '删除菜单', '77', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[87]', '192.168.1.75', '2018-04-09 21:13:42');
INSERT INTO `sys_log` VALUES ('175', '4', 'jituan', '删除菜单', '27', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[85]', '192.168.1.75', '2018-04-09 21:13:48');
INSERT INTO `sys_log` VALUES ('176', '1', 'admin', '修改用户', '101', 'net.chenlin.dp.modules.sys.controller.SysUserController.update()', '{\"userId\":6,\"orgId\":20,\"orgName\":\"培训一部\",\"username\":\"ranqisong\",\"password\":\"d6c50fe8157f75f958b9bc8709fde17b\",\"email\":\"123\",\"mobile\":\"12345678901\",\"status\":1,\"userIdCreate\":null,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[42]}', '192.168.1.74', '2018-04-09 21:13:49');
INSERT INTO `sys_log` VALUES ('177', '4', 'jituan', '删除菜单', '74', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[75]', '192.168.1.75', '2018-04-09 21:13:56');
INSERT INTO `sys_log` VALUES ('178', '4', 'jituan', '删除菜单', '48', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[74]', '192.168.1.75', '2018-04-09 21:14:03');
INSERT INTO `sys_log` VALUES ('179', '4', 'jituan', '删除菜单', '57', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[73]', '192.168.1.75', '2018-04-09 21:14:09');
INSERT INTO `sys_log` VALUES ('180', '4', 'jituan', '删除菜单', '67', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[72]', '192.168.1.75', '2018-04-09 21:14:14');
INSERT INTO `sys_log` VALUES ('181', '4', 'jituan', '删除菜单', '57', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[71]', '192.168.1.75', '2018-04-09 21:14:20');
INSERT INTO `sys_log` VALUES ('182', '1', 'admin', '数据权限', '31', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":42,\"orgId\":18,\"orgName\":\"培训部\",\"roleName\":\"培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[],\"orgIdList\":[20],\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.74', '2018-04-09 21:14:25');
INSERT INTO `sys_log` VALUES ('183', '4', 'jituan', '删除菜单', '54', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[70]', '192.168.1.75', '2018-04-09 21:14:28');
INSERT INTO `sys_log` VALUES ('184', '-1', null, '退出系统', '26', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:14:30');
INSERT INTO `sys_log` VALUES ('185', '-1', '获取用户信息为空', '登录', '33', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:14:39');
INSERT INTO `sys_log` VALUES ('186', '4', 'jituan', '删除菜单', '83', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[84]', '192.168.1.75', '2018-04-09 21:14:41');
INSERT INTO `sys_log` VALUES ('187', '4', 'jituan', '删除菜单', '141', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[83]', '192.168.1.75', '2018-04-09 21:14:49');
INSERT INTO `sys_log` VALUES ('188', '4', 'jituan', '删除菜单', '49', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[82]', '192.168.1.75', '2018-04-09 21:14:55');
INSERT INTO `sys_log` VALUES ('189', '4', 'jituan', '删除菜单', '54', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[81]', '192.168.1.75', '2018-04-09 21:15:02');
INSERT INTO `sys_log` VALUES ('190', '4', 'jituan', '删除菜单', '55', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[80]', '192.168.1.75', '2018-04-09 21:15:09');
INSERT INTO `sys_log` VALUES ('191', '4', 'jituan', '删除菜单', '49', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[79]', '192.168.1.75', '2018-04-09 21:15:15');
INSERT INTO `sys_log` VALUES ('192', '4', 'jituan', '删除菜单', '55', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[78]', '192.168.1.75', '2018-04-09 21:15:20');
INSERT INTO `sys_log` VALUES ('193', '4', 'jituan', '删除菜单', '77', 'net.chenlin.dp.modules.sys.controller.SysMenuController.remove()', '[77]', '192.168.1.75', '2018-04-09 21:15:23');
INSERT INTO `sys_log` VALUES ('194', '-1', null, '退出系统', '27', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:16:19');
INSERT INTO `sys_log` VALUES ('195', '-1', '获取用户信息为空', '登录', '34', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:16:20');
INSERT INTO `sys_log` VALUES ('196', '1', 'admin', '修改机构', '38', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":3,\"parentId\":2,\"parentName\":\"壹路驾校\",\"code\":\"yl-scb\",\"name\":\"壹路市场部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:20:11');
INSERT INTO `sys_log` VALUES ('197', '1', 'admin', '修改机构', '30', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":4,\"parentId\":3,\"parentName\":\"壹路市场部\",\"code\":\"yl-scb-001\",\"name\":\"壹路市场一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:20:50');
INSERT INTO `sys_log` VALUES ('198', '1', 'admin', '修改机构', '36', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":24,\"parentId\":21,\"parentName\":\"市场部\",\"code\":\"ht-scb-001\",\"name\":\"华通市场一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:21:05');
INSERT INTO `sys_log` VALUES ('199', '1', 'admin', '修改机构', '24', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":25,\"parentId\":21,\"parentName\":\"市场部\",\"code\":\"ht-scb-002\",\"name\":\"华通市场二部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:21:17');
INSERT INTO `sys_log` VALUES ('200', '1', 'admin', '新增机构', '70', 'net.chenlin.dp.modules.sys.controller.SysOrgController.save()', '{\"orgId\":null,\"parentId\":22,\"parentName\":\"培训部\",\"code\":\"ht1\",\"name\":\"华通培训一部\",\"orderNum\":0,\"status\":0,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:22:06');
INSERT INTO `sys_log` VALUES ('201', '1', 'admin', '修改机构', '46', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":21,\"parentId\":17,\"parentName\":\"华通驾校\",\"code\":\"ht-scb\",\"name\":\"华通市场部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:22:22');
INSERT INTO `sys_log` VALUES ('202', '1', 'admin', '修改机构', '24', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":22,\"parentId\":17,\"parentName\":\"华通驾校\",\"code\":\"ht-pxb\",\"name\":\"华通培训部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:22:34');
INSERT INTO `sys_log` VALUES ('203', '1', 'admin', '修改机构', '23', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":18,\"parentId\":2,\"parentName\":\"壹路驾校\",\"code\":\"yl-pxb\",\"name\":\"壹路培训部\",\"orderNum\":1,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:22:56');
INSERT INTO `sys_log` VALUES ('204', '1', 'admin', '修改机构', '23', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":20,\"parentId\":18,\"parentName\":\"壹路培训部\",\"code\":\"yl-pxb-001\",\"name\":\"壹路培训一部\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:23:12');
INSERT INTO `sys_log` VALUES ('205', '1', 'admin', '数据权限', '89', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":42,\"orgId\":18,\"orgName\":\"壹路培训部\",\"roleName\":\"培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[],\"orgIdList\":[20],\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.74', '2018-04-09 21:24:32');
INSERT INTO `sys_log` VALUES ('206', '-1', null, '退出系统', '31', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:24:36');
INSERT INTO `sys_log` VALUES ('207', '-1', '获取用户信息为空', '登录', '31', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:24:43');
INSERT INTO `sys_log` VALUES ('208', '-1', null, '退出系统', '26', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:24:51');
INSERT INTO `sys_log` VALUES ('209', '-1', '获取用户信息为空', '登录', '32', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:24:52');
INSERT INTO `sys_log` VALUES ('210', '1', 'admin', '操作权限', '30', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":42,\"orgId\":18,\"orgName\":\"壹路培训部\",\"roleName\":\"培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94],\"orgIdList\":[20],\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.74', '2018-04-09 21:25:17');
INSERT INTO `sys_log` VALUES ('211', '-1', null, '退出系统', '35', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:25:22');
INSERT INTO `sys_log` VALUES ('212', '-1', '获取用户信息为空', '登录', '33', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:25:24');
INSERT INTO `sys_log` VALUES ('213', '6', 'ranqisong', '新增来访登记', '34', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"黄复兴\",\"content\":\"学车困难\",\"mobile\":\"1234567890\",\"contactAddress\":\"12312\",\"orgId\":20,\"userId\":6,\"remarks\":\"3123\",\"operator\":\"ranqisong\",\"createTime\":1523280345546,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.74', '2018-04-09 21:25:45');
INSERT INTO `sys_log` VALUES ('214', '-1', null, '退出系统', '22', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:25:55');
INSERT INTO `sys_log` VALUES ('215', '-1', '获取用户信息为空', '登录', '28', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:25:56');
INSERT INTO `sys_log` VALUES ('216', '1', 'admin', '数据权限', '84', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":42,\"orgId\":18,\"orgName\":\"壹路培训部\",\"roleName\":\"培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94],\"orgIdList\":[20],\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.74', '2018-04-09 21:26:18');
INSERT INTO `sys_log` VALUES ('217', '-1', null, '退出系统', '33', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:26:24');
INSERT INTO `sys_log` VALUES ('218', '-1', '获取用户信息为空', '登录', '25', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:26:26');
INSERT INTO `sys_log` VALUES ('219', '6', 'ranqisong', '新增来访登记', '27', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"冉启松\",\"content\":\"123\",\"mobile\":\"12345678901\",\"contactAddress\":\"九龙坡百康年\",\"orgId\":20,\"userId\":6,\"remarks\":\"12312312\",\"operator\":\"ranqisong\",\"createTime\":1523280442435,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.74', '2018-04-09 21:27:22');
INSERT INTO `sys_log` VALUES ('220', '-1', null, '退出系统', '25', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:28:40');
INSERT INTO `sys_log` VALUES ('221', '-1', '获取用户信息为空', '登录', '41', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 21:28:41');
INSERT INTO `sys_log` VALUES ('222', '1', 'admin', '新增来访登记', '29', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"fd费\",\"content\":\"水电费\",\"mobile\":\"水电费v\",\"contactAddress\":\"水电费\",\"orgId\":1,\"userId\":1,\"remarks\":\"东方控股湖北\",\"operator\":\"admin\",\"createTime\":1523280545241,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:29:05');
INSERT INTO `sys_log` VALUES ('223', '1', 'admin', '修改角色', '41', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRole()', '{\"roleId\":42,\"orgId\":20,\"orgName\":\"壹路培训一部\",\"roleName\":\"培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94],\"orgIdList\":[20],\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.75', '2018-04-09 21:30:41');
INSERT INTO `sys_log` VALUES ('224', '-1', null, '退出系统', '32', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:31:05');
INSERT INTO `sys_log` VALUES ('225', '-1', '获取用户信息为空', '登录', '31', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.75', '2018-04-09 21:31:09');
INSERT INTO `sys_log` VALUES ('226', '6', 'ranqisong', '新增来访登记', '31', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"地方\",\"content\":\"地方\",\"mobile\":\"电饭锅\",\"contactAddress\":\"地方个\",\"orgId\":20,\"userId\":6,\"remarks\":\"地方\",\"operator\":\"ranqisong\",\"createTime\":1523280682670,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:31:22');
INSERT INTO `sys_log` VALUES ('227', '6', 'ranqisong', '新增来访登记', '27', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"非常\",\"content\":\"发给好\",\"mobile\":\"个 \",\"contactAddress\":\"电饭锅\",\"orgId\":20,\"userId\":6,\"remarks\":\"电饭锅\",\"operator\":\"ranqisong\",\"createTime\":1523280709699,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:31:49');
INSERT INTO `sys_log` VALUES ('228', '6', 'ranqisong', '新增来访登记', '68', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"VB吗\",\"content\":\"发给\",\"mobile\":\"发给\",\"contactAddress\":\"发给\",\"orgId\":20,\"userId\":6,\"remarks\":\" 发给\",\"operator\":\"ranqisong\",\"createTime\":1523281101063,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:38:21');
INSERT INTO `sys_log` VALUES ('229', '6', 'ranqisong', '新增来访登记', '59', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"VC\",\"content\":\"地方\",\"mobile\":\"地方\",\"contactAddress\":\"地方\",\"orgId\":20,\"userId\":6,\"remarks\":\" 地方\",\"operator\":\"ranqisong\",\"createTime\":1523281135346,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:38:55');
INSERT INTO `sys_log` VALUES ('230', '6', 'ranqisong', '新增来访登记', '36', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"辅导班\",\"content\":\"地方\",\"mobile\":\" 地方\",\"contactAddress\":\"地方\",\"orgId\":20,\"userId\":6,\"remarks\":\"的\",\"operator\":\"ranqisong\",\"createTime\":1523281176319,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:39:36');
INSERT INTO `sys_log` VALUES ('231', '6', 'ranqisong', '新增来访登记', '43', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"发给\",\"content\":\"发给\",\"mobile\":\"发给\",\"contactAddress\":\" 发过火\",\"orgId\":20,\"userId\":6,\"remarks\":\" 发过火\",\"operator\":\"ranqisong\",\"createTime\":1523281234095,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:40:34');
INSERT INTO `sys_log` VALUES ('232', '6', 'ranqisong', '新增来访登记', '34', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"想\",\"content\":\"想\",\"mobile\":\"想\",\"contactAddress\":\"想\",\"orgId\":20,\"userId\":6,\"remarks\":\"想\",\"operator\":\"ranqisong\",\"createTime\":1523281456727,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:44:16');
INSERT INTO `sys_log` VALUES ('233', '-1', null, '退出系统', '89', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:45:41');
INSERT INTO `sys_log` VALUES ('234', '-1', '获取用户信息为空', '登录', '82', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 21:45:43');
INSERT INTO `sys_log` VALUES ('235', '1', 'admin', '数据权限', '124', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":1,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"roleName\":\"系统管理员\",\"roleSign\":\"admin\",\"remark\":\"【系统内置：开发者使用】\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94,37,38,39,40,41,2,20,21,22,23,4,32,33,34,35,27,28,29,30,47,48,49,50,51,55,56,57,58,68,52,53,54,59,60,61,67,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2,20],\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.75', '2018-04-09 21:46:23');
INSERT INTO `sys_log` VALUES ('236', '-1', '获取用户信息为空', '登录', '36', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:46:27');
INSERT INTO `sys_log` VALUES ('237', '1', 'admin', '修改机构', '29', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":19,\"parentId\":2,\"parentName\":\"壹路驾校\",\"code\":\"yl-xzrl\",\"name\":\"壹路行政人力\",\"orderNum\":2,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:46:46');
INSERT INTO `sys_log` VALUES ('238', '-1', '获取用户信息为空', '登录', '36', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 21:46:48');
INSERT INTO `sys_log` VALUES ('239', '-1', '获取用户信息为空', '登录', '34', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:47:15');
INSERT INTO `sys_log` VALUES ('240', '1', 'admin', '新增来访登记', '42', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"出\",\"content\":\"出\",\"mobile\":\"出\",\"contactAddress\":\"出\",\"orgId\":1,\"userId\":1,\"remarks\":\"出\",\"operator\":\"admin\",\"createTime\":1523281669300,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:47:49');
INSERT INTO `sys_log` VALUES ('241', '6', 'ranqisong', '新增来访登记', '46', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"娟\",\"content\":\"学车困难\",\"mobile\":\"123\",\"contactAddress\":\"大坪医院\",\"orgId\":20,\"userId\":6,\"remarks\":\"12312\",\"operator\":\"ranqisong\",\"createTime\":1523281696721,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.74', '2018-04-09 21:48:16');
INSERT INTO `sys_log` VALUES ('242', '6', 'ranqisong', '修改来访登记', '35', 'net.chenlin.dp.modules.visit.controller.VisitController.update()', '{\"id\":12265,\"name\":\"娟\",\"content\":\"学车困难\",\"mobile\":\"123\",\"contactAddress\":\"大坪医院\",\"orgId\":20,\"userId\":null,\"remarks\":\"12312123\",\"operator\":\"ranqisong\",\"createTime\":1523281697000,\"updateTime\":1523281708099,\"deleteTime\":null}', '192.168.1.74', '2018-04-09 21:48:28');
INSERT INTO `sys_log` VALUES ('243', '6', 'ranqisong', '删除来访登记', '87', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12258,12257,12256]', '192.168.1.74', '2018-04-09 21:48:35');
INSERT INTO `sys_log` VALUES ('244', '-1', null, '退出系统', '36', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:48:39');
INSERT INTO `sys_log` VALUES ('245', '-1', '获取用户信息为空', '登录', '43', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:48:40');
INSERT INTO `sys_log` VALUES ('246', '1', 'admin', '修改机构', '41', 'net.chenlin.dp.modules.sys.controller.SysOrgController.update()', '{\"orgId\":23,\"parentId\":17,\"parentName\":\"华通驾校\",\"code\":\"ht-xzrl\",\"name\":\"华通行政人力\",\"orderNum\":0,\"status\":1,\"gmtCreate\":null,\"gmtModified\":null,\"open\":null,\"list\":null}', '192.168.1.74', '2018-04-09 21:48:54');
INSERT INTO `sys_log` VALUES ('247', '-1', null, '退出系统', '31', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:49:03');
INSERT INTO `sys_log` VALUES ('248', '-1', '获取用户信息为空', '登录', '67', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:50:17');
INSERT INTO `sys_log` VALUES ('249', '-1', null, '退出系统', '27', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:50:28');
INSERT INTO `sys_log` VALUES ('250', '-1', '获取用户信息为空', '登录', '68', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '192.168.1.74', '2018-04-09 21:50:31');
INSERT INTO `sys_log` VALUES ('251', '-1', null, '退出系统', '147', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.74', '2018-04-09 21:50:40');
INSERT INTO `sys_log` VALUES ('252', '-1', '获取用户信息为空', '登录', '151', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.74', '2018-04-09 21:50:42');
INSERT INTO `sys_log` VALUES ('253', '-1', '获取用户信息为空', '登录', '67', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 21:51:15');
INSERT INTO `sys_log` VALUES ('254', '-1', null, '退出系统', '35', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:51:59');
INSERT INTO `sys_log` VALUES ('255', '-1', '获取用户信息为空', '登录', '32', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"jituan\"', '192.168.1.75', '2018-04-09 21:52:04');
INSERT INTO `sys_log` VALUES ('256', '4', 'jituan', '新增来访登记', '40', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"想\",\"content\":\"地方\",\"mobile\":\"的\",\"contactAddress\":\"的\",\"orgId\":1,\"userId\":4,\"remarks\":\"的\",\"operator\":\"jituan\",\"createTime\":1523281951140,\"updateTime\":null,\"deleteTime\":null}', '192.168.1.75', '2018-04-09 21:52:31');
INSERT INTO `sys_log` VALUES ('257', '-1', null, '退出系统', '32', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:53:48');
INSERT INTO `sys_log` VALUES ('258', '-1', '获取用户信息为空', '登录', '31', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 21:53:50');
INSERT INTO `sys_log` VALUES ('259', '1', 'admin', '数据权限', '56', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":39,\"orgId\":1,\"orgName\":\"壹鹿集团\",\"roleName\":\"集团CEO\",\"roleSign\":\"CEO\",\"remark\":\"集团老板\",\"userIdCreate\":null,\"menuIdList\":[1],\"orgIdList\":[1,2,3,4,18,20,19,17,23,22,26,21,25,24],\"gmtCreate\":null,\"gmtModified\":null}', '192.168.1.75', '2018-04-09 21:54:28');
INSERT INTO `sys_log` VALUES ('260', '-1', null, '退出系统', '29', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:54:32');
INSERT INTO `sys_log` VALUES ('261', '-1', '获取用户信息为空', '登录', '27', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"jituan\"', '192.168.1.75', '2018-04-09 21:54:34');
INSERT INTO `sys_log` VALUES ('262', '-1', '获取用户信息为空', '登录', '32', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"jituan\"', '192.168.1.75', '2018-04-09 21:55:00');
INSERT INTO `sys_log` VALUES ('263', '-1', null, '退出系统', '28', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:55:09');
INSERT INTO `sys_log` VALUES ('264', '-1', '获取用户信息为空', '登录', '38', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 21:55:15');
INSERT INTO `sys_log` VALUES ('265', '-1', null, '退出系统', '24', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '192.168.1.75', '2018-04-09 21:55:34');
INSERT INTO `sys_log` VALUES ('266', '-1', '获取用户信息为空', '登录', '32', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '192.168.1.75', '2018-04-09 21:55:43');
INSERT INTO `sys_log` VALUES ('267', '-1', '获取用户信息为空', '登录', '151', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-04-09 22:28:03');
INSERT INTO `sys_log` VALUES ('268', '-1', null, '退出系统', '43', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 22:38:20');
INSERT INTO `sys_log` VALUES ('269', '-1', '获取用户信息为空', '登录', '51', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"jituan\"', '0:0:0:0:0:0:0:1', '2018-04-09 22:38:31');
INSERT INTO `sys_log` VALUES ('270', '-1', null, '退出系统', '35', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 22:38:55');
INSERT INTO `sys_log` VALUES ('271', '-1', '获取用户信息为空', '登录', '40', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-04-09 22:38:58');
INSERT INTO `sys_log` VALUES ('272', '-1', null, '退出系统', '33', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 22:39:36');
INSERT INTO `sys_log` VALUES ('273', '-1', '获取用户信息为空', '登录', '34', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '0:0:0:0:0:0:0:1', '2018-04-09 22:39:41');
INSERT INTO `sys_log` VALUES ('274', '6', 'ranqisong', '删除来访登记', '33', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12260]', '0:0:0:0:0:0:0:1', '2018-04-09 22:46:14');
INSERT INTO `sys_log` VALUES ('275', '6', 'ranqisong', '删除来访登记', '35', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12255]', '0:0:0:0:0:0:0:1', '2018-04-09 22:46:19');
INSERT INTO `sys_log` VALUES ('276', '6', 'ranqisong', '删除来访登记', '37', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12254]', '0:0:0:0:0:0:0:1', '2018-04-09 22:46:25');
INSERT INTO `sys_log` VALUES ('277', '6', 'ranqisong', '删除来访登记', '28', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12259]', '0:0:0:0:0:0:0:1', '2018-04-09 22:46:28');
INSERT INTO `sys_log` VALUES ('278', '6', 'ranqisong', '删除来访登记', '32', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12261]', '0:0:0:0:0:0:0:1', '2018-04-09 22:46:32');
INSERT INTO `sys_log` VALUES ('279', '6', 'ranqisong', '删除来访登记', '42', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12262]', '0:0:0:0:0:0:0:1', '2018-04-09 22:46:36');
INSERT INTO `sys_log` VALUES ('280', '6', 'ranqisong', '删除来访登记', '31', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12263]', '0:0:0:0:0:0:0:1', '2018-04-09 22:46:40');
INSERT INTO `sys_log` VALUES ('281', '-1', null, '退出系统', '35', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 22:47:06');
INSERT INTO `sys_log` VALUES ('282', '-1', '获取用户信息为空', '登录', '49', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-04-09 22:47:08');
INSERT INTO `sys_log` VALUES ('283', '1', 'admin', '删除来访登记', '25', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12250]', '0:0:0:0:0:0:0:1', '2018-04-09 22:47:18');
INSERT INTO `sys_log` VALUES ('284', '1', 'admin', '删除来访登记', '33', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12252]', '0:0:0:0:0:0:0:1', '2018-04-09 22:47:22');
INSERT INTO `sys_log` VALUES ('285', '1', 'admin', '删除来访登记', '30', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12253]', '0:0:0:0:0:0:0:1', '2018-04-09 22:47:25');
INSERT INTO `sys_log` VALUES ('286', '1', 'admin', '删除来访登记', '33', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12264]', '0:0:0:0:0:0:0:1', '2018-04-09 22:47:28');
INSERT INTO `sys_log` VALUES ('287', '1', 'admin', '删除来访登记', '36', 'net.chenlin.dp.modules.visit.controller.VisitController.batchRemove()', '[12265]', '0:0:0:0:0:0:0:1', '2018-04-09 22:47:32');
INSERT INTO `sys_log` VALUES ('288', '-1', null, '退出系统', '32', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 23:05:04');
INSERT INTO `sys_log` VALUES ('289', '-1', '获取用户信息为空', '登录', '39', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"jituan\"', '0:0:0:0:0:0:0:1', '2018-04-09 23:05:07');
INSERT INTO `sys_log` VALUES ('290', '4', 'jituan', '新增来访登记', '45', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"想\",\"content\":\"想\",\"mobile\":\"想\",\"contactAddress\":\"想\",\"orgId\":1,\"userId\":4,\"remarks\":\"想\",\"operator\":\"jituan\",\"createTime\":1523287500346,\"updateTime\":null,\"deleteTime\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:25:00');
INSERT INTO `sys_log` VALUES ('291', '4', 'jituan', '修改来访登记', '28', 'net.chenlin.dp.modules.visit.controller.VisitController.update()', '{\"id\":12266,\"name\":\"个\",\"content\":\"地方\",\"mobile\":\"的\",\"contactAddress\":\"的\",\"orgId\":1,\"userId\":null,\"remarks\":\"的\",\"operator\":\"jituan\",\"createTime\":1523281951000,\"updateTime\":1523287511863,\"deleteTime\":null}', '127.0.0.1', '2018-04-09 23:25:11');
INSERT INTO `sys_log` VALUES ('292', '4', 'jituan', '数据权限', '56', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":42,\"orgId\":20,\"orgName\":\"壹路培训一部\",\"roleName\":\"培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94],\"orgIdList\":[1,2,3,4,18,20,19],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:45:30');
INSERT INTO `sys_log` VALUES ('293', '-1', null, '退出系统', '50', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 23:46:24');
INSERT INTO `sys_log` VALUES ('294', '-1', '获取用户信息为空', '登录', '49', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '0:0:0:0:0:0:0:1', '2018-04-09 23:46:27');
INSERT INTO `sys_log` VALUES ('295', '6', 'ranqisong', '新增来访登记', '42', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"在\",\"content\":\"在\",\"mobile\":\"在\",\"contactAddress\":\"在\",\"orgId\":20,\"userIdCreate\":6,\"remarks\":\"在\",\"operator\":\"ranqisong\",\"createTime\":1523289126980,\"updateTime\":null,\"deleteTime\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:52:07');
INSERT INTO `sys_log` VALUES ('296', '6', 'ranqisong', '修改来访登记', '41', 'net.chenlin.dp.modules.visit.controller.VisitController.update()', '{\"id\":12268,\"name\":\"在2\",\"content\":\"在\",\"mobile\":\"在\",\"contactAddress\":\"在\",\"orgId\":20,\"userIdCreate\":6,\"remarks\":\"在\",\"operator\":\"ranqisong\",\"createTime\":1523289127000,\"updateTime\":1523289140205,\"deleteTime\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:52:20');
INSERT INTO `sys_log` VALUES ('297', '-1', null, '退出系统', '35', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 23:53:04');
INSERT INTO `sys_log` VALUES ('298', '-1', '获取用户信息为空', '登录', '49', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"admin\"', '0:0:0:0:0:0:0:1', '2018-04-09 23:53:05');
INSERT INTO `sys_log` VALUES ('299', '1', 'admin', '修改角色', '30', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRole()', '{\"roleId\":42,\"orgId\":20,\"orgName\":\"壹路培训一部\",\"roleName\":\"壹路培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94],\"orgIdList\":[1,2,3,4,18,20,19],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:53:26');
INSERT INTO `sys_log` VALUES ('300', '1', 'admin', '操作权限', '64', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":42,\"orgId\":20,\"orgName\":\"壹路培训一部\",\"roleName\":\"壹路培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2,3,4,18,20,19],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:53:55');
INSERT INTO `sys_log` VALUES ('301', '1', 'admin', '数据权限', '58', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":42,\"orgId\":20,\"orgName\":\"壹路培训一部\",\"roleName\":\"壹路培训人员\",\"roleSign\":\"guest\",\"remark\":\"培训人员\",\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94,3,36,42,43,44,45,7,15,16,17,18,19,46,6,11,12,13,14,24,25,26],\"orgIdList\":[1,2,3,4,18,20,19,24],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:54:10');
INSERT INTO `sys_log` VALUES ('302', '1', 'admin', '新增角色', '29', 'net.chenlin.dp.modules.sys.controller.SysRoleController.saveRole()', '{\"roleId\":null,\"orgId\":24,\"orgName\":\"华通市场一部\",\"roleName\":\"华通市场部人员\",\"roleSign\":\"scs\",\"remark\":null,\"userIdCreate\":1,\"menuIdList\":null,\"orgIdList\":null,\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:55:01');
INSERT INTO `sys_log` VALUES ('303', '1', 'admin', '数据权限', '35', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":43,\"orgId\":24,\"orgName\":\"华通市场一部\",\"roleName\":\"华通市场部人员\",\"roleSign\":\"scs\",\"remark\":null,\"userIdCreate\":null,\"menuIdList\":[],\"orgIdList\":[24],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:55:15');
INSERT INTO `sys_log` VALUES ('304', '1', 'admin', '新增用户', '61', 'net.chenlin.dp.modules.sys.controller.SysUserController.save()', '{\"userId\":7,\"orgId\":24,\"orgName\":\"华通市场一部\",\"username\":\"huatong001\",\"password\":\"fe19aeee1b8e45364bfd74a022c7ee0c\",\"email\":null,\"mobile\":null,\"status\":1,\"userIdCreate\":1,\"remark\":null,\"gmtCreate\":null,\"gmtModified\":null,\"roleIdList\":[43]}', '0:0:0:0:0:0:0:1', '2018-04-09 23:56:00');
INSERT INTO `sys_log` VALUES ('305', '1', 'admin', '操作权限', '37', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleOptAuthorization()', '{\"roleId\":43,\"orgId\":24,\"orgName\":\"华通市场一部\",\"roleName\":\"华通市场部人员\",\"roleSign\":\"scs\",\"remark\":null,\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94],\"orgIdList\":[24],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:56:35');
INSERT INTO `sys_log` VALUES ('306', '1', 'admin', '数据权限', '50', 'net.chenlin.dp.modules.sys.controller.SysRoleController.updateRoleDataAuthorization()', '{\"roleId\":43,\"orgId\":24,\"orgName\":\"华通市场一部\",\"roleName\":\"华通市场部人员\",\"roleSign\":\"scs\",\"remark\":null,\"userIdCreate\":null,\"menuIdList\":[1,90,91,92,93,94],\"orgIdList\":[24],\"gmtCreate\":null,\"gmtModified\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:56:43');
INSERT INTO `sys_log` VALUES ('307', '-1', null, '退出系统', '35', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-09 23:56:53');
INSERT INTO `sys_log` VALUES ('308', '-1', '获取用户信息为空', '登录', '40', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"huatong001\"', '0:0:0:0:0:0:0:1', '2018-04-09 23:57:01');
INSERT INTO `sys_log` VALUES ('309', '7', 'huatong001', '新增来访登记', '37', 'net.chenlin.dp.modules.visit.controller.VisitController.save()', '{\"id\":0,\"name\":\"华通市场部\",\"content\":\"华通市场部\",\"mobile\":\"华通市场部\",\"contactAddress\":\"华通市场部\",\"orgId\":24,\"userIdCreate\":7,\"remarks\":\"华通市场部\",\"operator\":\"huatong001\",\"createTime\":1523289448219,\"updateTime\":null,\"deleteTime\":null}', '0:0:0:0:0:0:0:1', '2018-04-09 23:57:28');
INSERT INTO `sys_log` VALUES ('310', '-1', null, '退出系统', '46', 'net.chenlin.dp.modules.sys.controller.SysLoginController.logout()', null, '0:0:0:0:0:0:0:1', '2018-04-10 00:04:23');
INSERT INTO `sys_log` VALUES ('311', '-1', '获取用户信息为空', '登录', '52', 'net.chenlin.dp.modules.sys.controller.SysLoginController.login()', '\"ranqisong\"', '0:0:0:0:0:0:0:1', '2018-04-10 00:04:27');
...
INSERT INTO `sys_menu` VALUES ('90', '1', '来访登记', 'base/visit/list.html', null, '1', 'fa fa-circle-o', null, null, null);
INSERT INTO `sys_menu` VALUES ('91', '90', '刷新', '', 'visit:visit:list', '2', 'fa fa-circle-o', null, null, null);
INSERT INTO `sys_menu` VALUES ('92', '90', '新增', '', 'visit:visit:save', '2', 'fa fa-circle-o', null, null, null);
INSERT INTO `sys_menu` VALUES ('93', '90', '修改', '', 'visit:visit:edit', '2', 'fa fa-circle-o', null, null, null);
INSERT INTO `sys_menu` VALUES ('94', '90', '删除', '', 'visit:visit:remove', '2', 'fa fa-circle-o', null, null, null);
...
CREATE TABLE `sys_org` (
  ...
  `gmt_modified` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`org_id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='机构管理';

-- ----------------------------
-- Records of sys_org
-- ----------------------------
INSERT INTO `sys_org` VALUES ('1', '0', 'yljt', '壹鹿集团', '0', '1', '2017-08-17 12:03:15', '2018-04-09 20:45:14');
INSERT INTO `sys_org` VALUES ('2', '1', 'yilu', '壹路驾校', '0', '1', '2017-08-17 12:03:43', '2018-04-09 20:45:39');
INSERT INTO `sys_org` VALUES ('3', '2', 'yl-scb', '壹路市场部', '0', '1', '2017-08-17 12:04:47', '2018-04-09 21:20:11');
INSERT INTO `sys_org` VALUES ('4', '3', 'yl-scb-001', '壹路市场一部', '0', '1', '2017-08-17 12:05:31', '2018-04-09 21:20:50');
INSERT INTO `sys_org` VALUES ('17', '1', 'huatong', '华通驾校', '1', '1', '2018-01-05 10:08:09', null);
INSERT INTO `sys_org` VALUES ('18', '2', 'yl-pxb', '壹路培训部', '1', '1', '2018-01-05 10:09:04', '2018-04-09 21:22:56');
INSERT INTO `sys_org` VALUES ('19', '2', 'yl-xzrl', '壹路行政人力', '2', '1', '2018-01-05 10:09:41', '2018-04-09 21:46:46');
INSERT INTO `sys_org` VALUES ('20', '18', 'yl-pxb-001', '壹路培训一部', '0', '1', '2018-01-05 10:10:34', '2018-04-09 21:23:12');
INSERT INTO `sys_org` VALUES ('21', '17', 'ht-scb', '华通市场部', '0', '1', '2018-04-09 20:40:38', '2018-04-09 21:22:22');
INSERT INTO `sys_org` VALUES ('22', '17', 'ht-pxb', '华通培训部', '0', '1', '2018-04-09 20:41:05', '2018-04-09 21:22:34');
INSERT INTO `sys_org` VALUES ('23', '17', 'ht-xzrl', '华通行政人力', '0', '1', '2018-04-09 20:41:40', '2018-04-09 21:48:54');
INSERT INTO `sys_org` VALUES ('24', '21', 'ht-scb-001', '华通市场一部', '0', '1', '2018-04-09 20:42:16', '2018-04-09 21:21:05');
INSERT INTO `sys_org` VALUES ('25', '21', 'ht-scb-002', '华通市场二部', '0', '1', '2018-04-09 20:42:50', '2018-04-09 21:21:17');
INSERT INTO `sys_org` VALUES ('26', '22', 'ht1', '华通培训一部', '0', '0', '2018-04-09 21:22:06', null);
...
CREATE TABLE `sys_role` (
  ...
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='系统角色';

-- ----------------------------
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1', '1', '系统管理员', 'admin', '【系统内置：开发者使用】', '2', '2017-08-12 00:43:52', '2018-01-05 10:14:06');
INSERT INTO `sys_role` VALUES ('39', '1', '集团CEO', 'CEO', '集团老板', '1', '2017-08-17 19:41:15', '2018-01-05 10:14:46');
INSERT INTO `sys_role` VALUES ('40', '17', '华通驾校CEO', 'ht-ceo', '华通驾校老大', '1', '2018-01-05 10:15:39', null);
INSERT INTO `sys_role` VALUES ('41', '2', '一路驾校CEO', 'ylu-ceo', '一路驾校老大', '1', '2018-01-05 10:16:21', null);
INSERT INTO `sys_role` VALUES ('42', '20', '壹路培训人员', 'guest', '培训人员', '1', '2018-04-09 21:06:18', '2018-04-09 23:53:26');
INSERT INTO `sys_role` VALUES ('43', '24', '华通市场部人员', 'scs', null, '1', '2018-04-09 23:55:01', null);
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1666 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';

-- ----------------------------
-- Records of sys_role_menu
-- ----------------------------
INSERT INTO `sys_role_menu` VALUES ('1545', '39', '1');
INSERT INTO `sys_role_menu` VALUES ('1551', '1', '1');
INSERT INTO `sys_role_menu` VALUES ('1557', '1', '90');
INSERT INTO `sys_role_menu` VALUES ('1558', '1', '91');
INSERT INTO `sys_role_menu` VALUES ('1559', '1', '92');
INSERT INTO `sys_role_menu` VALUES ('1560', '1', '93');
INSERT INTO `sys_role_menu` VALUES ('1561', '1', '94');
INSERT INTO `sys_role_menu` VALUES ('1562', '1', '37');
INSERT INTO `sys_role_menu` VALUES ('1563', '1', '38');
INSERT INTO `sys_role_menu` VALUES ('1564', '1', '39');
INSERT INTO `sys_role_menu` VALUES ('1565', '1', '40');
INSERT INTO `sys_role_menu` VALUES ('1566', '1', '41');
INSERT INTO `sys_role_menu` VALUES ('1567', '1', '2');
INSERT INTO `sys_role_menu` VALUES ('1568', '1', '20');
INSERT INTO `sys_role_menu` VALUES ('1569', '1', '21');
INSERT INTO `sys_role_menu` VALUES ('1570', '1', '22');
INSERT INTO `sys_role_menu` VALUES ('1571', '1', '23');
INSERT INTO `sys_role_menu` VALUES ('1572', '1', '4');
INSERT INTO `sys_role_menu` VALUES ('1573', '1', '32');
INSERT INTO `sys_role_menu` VALUES ('1574', '1', '33');
INSERT INTO `sys_role_menu` VALUES ('1575', '1', '34');
INSERT INTO `sys_role_menu` VALUES ('1576', '1', '35');
INSERT INTO `sys_role_menu` VALUES ('1577', '1', '27');
INSERT INTO `sys_role_menu` VALUES ('1578', '1', '28');
INSERT INTO `sys_role_menu` VALUES ('1579', '1', '29');
INSERT INTO `sys_role_menu` VALUES ('1580', '1', '30');
INSERT INTO `sys_role_menu` VALUES ('1581', '1', '47');
INSERT INTO `sys_role_menu` VALUES ('1582', '1', '48');
INSERT INTO `sys_role_menu` VALUES ('1583', '1', '49');
INSERT INTO `sys_role_menu` VALUES ('1584', '1', '50');
INSERT INTO `sys_role_menu` VALUES ('1585', '1', '51');
INSERT INTO `sys_role_menu` VALUES ('1586', '1', '55');
INSERT INTO `sys_role_menu` VALUES ('1587', '1', '56');
INSERT INTO `sys_role_menu` VALUES ('1588', '1', '57');
INSERT INTO `sys_role_menu` VALUES ('1589', '1', '58');
INSERT INTO `sys_role_menu` VALUES ('1590', '1', '68');
INSERT INTO `sys_role_menu` VALUES ('1591', '1', '52');
INSERT INTO `sys_role_menu` VALUES ('1592', '1', '53');
INSERT INTO `sys_role_menu` VALUES ('1593', '1', '54');
INSERT INTO `sys_role_menu` VALUES ('1594', '1', '59');
INSERT INTO `sys_role_menu` VALUES ('1595', '1', '60');
INSERT INTO `sys_role_menu` VALUES ('1596', '1', '61');
INSERT INTO `sys_role_menu` VALUES ('1597', '1', '67');
INSERT INTO `sys_role_menu` VALUES ('1606', '1', '3');
INSERT INTO `sys_role_menu` VALUES ('1607', '1', '36');
INSERT INTO `sys_role_menu` VALUES ('1608', '1', '42');
INSERT INTO `sys_role_menu` VALUES ('1609', '1', '43');
INSERT INTO `sys_role_menu` VALUES ('1610', '1', '44');
INSERT INTO `sys_role_menu` VALUES ('1611', '1', '45');
INSERT INTO `sys_role_menu` VALUES ('1612', '1', '7');
INSERT INTO `sys_role_menu` VALUES ('1613', '1', '15');
INSERT INTO `sys_role_menu` VALUES ('1614', '1', '16');
INSERT INTO `sys_role_menu` VALUES ('1615', '1', '17');
INSERT INTO `sys_role_menu` VALUES ('1616', '1', '18');
INSERT INTO `sys_role_menu` VALUES ('1617', '1', '19');
INSERT INTO `sys_role_menu` VALUES ('1618', '1', '46');
INSERT INTO `sys_role_menu` VALUES ('1619', '1', '6');
INSERT INTO `sys_role_menu` VALUES ('1620', '1', '11');
INSERT INTO `sys_role_menu` VALUES ('1621', '1', '12');
INSERT INTO `sys_role_menu` VALUES ('1622', '1', '13');
INSERT INTO `sys_role_menu` VALUES ('1623', '1', '14');
INSERT INTO `sys_role_menu` VALUES ('1624', '1', '24');
INSERT INTO `sys_role_menu` VALUES ('1625', '1', '25');
INSERT INTO `sys_role_menu` VALUES ('1626', '1', '26');
INSERT INTO `sys_role_menu` VALUES ('1633', '42', '1');
INSERT INTO `sys_role_menu` VALUES ('1634', '42', '90');
INSERT INTO `sys_role_menu` VALUES ('1635', '42', '91');
INSERT INTO `sys_role_menu` VALUES ('1636', '42', '92');
INSERT INTO `sys_role_menu` VALUES ('1637', '42', '93');
INSERT INTO `sys_role_menu` VALUES ('1638', '42', '94');
INSERT INTO `sys_role_menu` VALUES ('1639', '42', '3');
INSERT INTO `sys_role_menu` VALUES ('1640', '42', '36');
INSERT INTO `sys_role_menu` VALUES ('1641', '42', '42');
INSERT INTO `sys_role_menu` VALUES ('1642', '42', '43');
INSERT INTO `sys_role_menu` VALUES ('1643', '42', '44');
INSERT INTO `sys_role_menu` VALUES ('1644', '42', '45');
INSERT INTO `sys_role_menu` VALUES ('1645', '42', '7');
INSERT INTO `sys_role_menu` VALUES ('1646', '42', '15');
INSERT INTO `sys_role_menu` VALUES ('1647', '42', '16');
INSERT INTO `sys_role_menu` VALUES ('1648', '42', '17');
INSERT INTO `sys_role_menu` VALUES ('1649', '42', '18');
INSERT INTO `sys_role_menu` VALUES ('1650', '42', '19');
INSERT INTO `sys_role_menu` VALUES ('1651', '42', '46');
INSERT INTO `sys_role_menu` VALUES ('1652', '42', '6');
INSERT INTO `sys_role_menu` VALUES ('1653', '42', '11');
INSERT INTO `sys_role_menu` VALUES ('1654', '42', '12');
INSERT INTO `sys_role_menu` VALUES ('1655', '42', '13');
INSERT INTO `sys_role_menu` VALUES ('1656', '42', '14');
INSERT INTO `sys_role_menu` VALUES ('1657', '42', '24');
INSERT INTO `sys_role_menu` VALUES ('1658', '42', '25');
INSERT INTO `sys_role_menu` VALUES ('1659', '42', '26');
INSERT INTO `sys_role_menu` VALUES ('1660', '43', '1');
INSERT INTO `sys_role_menu` VALUES ('1661', '43', '90');
INSERT INTO `sys_role_menu` VALUES ('1662', '43', '91');
INSERT INTO `sys_role_menu` VALUES ('1663', '43', '92');
INSERT INTO `sys_role_menu` VALUES ('1664', '43', '93');
INSERT INTO `sys_role_menu` VALUES ('1665', '43', '94');
...
CREATE TABLE `sys_role_org` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='角色与机构对应关系';

-- ----------------------------
-- Records of sys_role_org
-- ----------------------------
INSERT INTO `sys_role_org` VALUES ('32', '1', '1');
INSERT INTO `sys_role_org` VALUES ('33', '1', '2');
INSERT INTO `sys_role_org` VALUES ('34', '1', '20');
INSERT INTO `sys_role_org` VALUES ('35', '39', '1');
INSERT INTO `sys_role_org` VALUES ('36', '39', '2');
INSERT INTO `sys_role_org` VALUES ('37', '39', '3');
INSERT INTO `sys_role_org` VALUES ('38', '39', '4');
INSERT INTO `sys_role_org` VALUES ('39', '39', '18');
INSERT INTO `sys_role_org` VALUES ('40', '39', '20');
INSERT INTO `sys_role_org` VALUES ('41', '39', '19');
INSERT INTO `sys_role_org` VALUES ('42', '39', '17');
INSERT INTO `sys_role_org` VALUES ('43', '39', '23');
INSERT INTO `sys_role_org` VALUES ('44', '39', '22');
INSERT INTO `sys_role_org` VALUES ('45', '39', '26');
INSERT INTO `sys_role_org` VALUES ('46', '39', '21');
INSERT INTO `sys_role_org` VALUES ('47', '39', '25');
INSERT INTO `sys_role_org` VALUES ('48', '39', '24');
INSERT INTO `sys_role_org` VALUES ('56', '42', '1');
INSERT INTO `sys_role_org` VALUES ('57', '42', '2');
INSERT INTO `sys_role_org` VALUES ('58', '42', '3');
INSERT INTO `sys_role_org` VALUES ('59', '42', '4');
INSERT INTO `sys_role_org` VALUES ('60', '42', '18');
INSERT INTO `sys_role_org` VALUES ('61', '42', '20');
INSERT INTO `sys_role_org` VALUES ('62', '42', '19');
INSERT INTO `sys_role_org` VALUES ('63', '42', '24');
INSERT INTO `sys_role_org` VALUES ('65', '43', '24');
...
INSERT INTO `sys_user` VALUES ('2', '2', 'yilu', '7fe81961d0b10fc534f43be1872a9448', '222', '22', '1', null, '1', '2017-12-20 13:22:19', '2018-04-09 20:51:29');
INSERT INTO `sys_user` VALUES ('3', '17', 'huatong', 'f3fd219f1c9546f282c772f11060db64', '99', '999', '1', null, '1', '2017-12-20 13:22:43', '2018-04-09 20:51:58');
INSERT INTO `sys_user` VALUES ('4', '1', 'jituan', '0ca0b429b8956d62956aee483de87095', null, null, '1', null, '1', '2018-04-09 20:52:41', '2018-04-09 21:12:46');
INSERT INTO `sys_user` VALUES ('5', '4', 'xiaoran', '706c728377e459a36c96c29c95d0c44f', '12312', '13456789012', '1', null, '4', '2018-04-09 21:05:00', '2018-04-09 21:06:31');
INSERT INTO `sys_user` VALUES ('6', '20', 'ranqisong', 'd6c50fe8157f75f958b9bc8709fde17b', '123', '12345678901', '1', null, '1', '2018-04-09 21:07:43', '2018-04-09 21:13:49');
INSERT INTO `sys_user` VALUES ('7', '24', 'huatong001', 'fe19aeee1b8e45364bfd74a022c7ee0c', null, null, '1', null, '1', '2018-04-09 23:56:00', null);
...
INSERT INTO `sys_user_role` VALUES ('50', '2', '41');
INSERT INTO `sys_user_role` VALUES ('51', '3', '40');
INSERT INTO `sys_user_role` VALUES ('54', '5', '42');
INSERT INTO `sys_user_role` VALUES ('56', '4', '1');
INSERT INTO `sys_user_role` VALUES ('58', '6', '42');
INSERT INTO `sys_user_role` VALUES ('59', '7', '43');
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES ('1', '90fdc841acfdea00a5168a912c1f1a4e', '2018-04-10 11:53:06', '2018-04-09 23:53:06');
INSERT INTO `sys_user_token` VALUES ('2', '5004cd9815f7b6e8ac8d831af7eb9324', '2017-09-05 04:04:34', '2017-09-04 16:04:34');
INSERT INTO `sys_user_token` VALUES ('4', '1b825e8ccc613a4df074f225a3d6453c', '2018-04-10 11:05:07', '2018-04-09 23:05:07');
INSERT INTO `sys_user_token` VALUES ('6', 'db51396d9e85ec64e2d9ab02570a5722', '2018-04-10 12:04:28', '2018-04-10 00:04:28');
INSERT INTO `sys_user_token` VALUES ('7', 'dcca0be4e3bf8ef8b430000878f6a0c4', '2018-04-10 11:57:01', '2018-04-09 23:57:01');
