...
CREATE TABLE `b_visit` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12267 DEFAULT CHARSET=utf8 COMMENT='来访登记';

-- ----------------------------
-- Records of b_visit
-- ----------------------------
INSERT INTO `b_visit` VALUES ('12250', 'dfgkj', 'fdgd', 'dfgfd', 'dfff', '1', '1', 'fdff', 'admin', '2018-04-09 20:05:36', null, null);
INSERT INTO `b_visit` VALUES ('12252', '123', '12312', '3123', '123', '1', '1', '123', 'admin', '2018-04-09 21:00:34', null, null);
INSERT INTO `b_visit` VALUES ('12253', 'admin', 'admin', '1231231', '23123', '1', '1', '123123', 'admin', '2018-04-09 21:03:12', null, null);
INSERT INTO `b_visit` VALUES ('12254', '黄复兴', '学车困难', '1234567890', '12312', '6', '20', '3123', 'ranqisong', '2018-04-09 21:25:46', null, null);
INSERT INTO `b_visit` VALUES ('12255', '冉启松', '123', '12345678901', '九龙坡百康年', '6', '20', '12312312', 'ranqisong', '2018-04-09 21:27:22', null, null);
INSERT INTO `b_visit` VALUES ('12259', 'VB吗', '发给', '发给', '发给', '6', '20', ' 发给', 'ranqisong', '2018-04-09 21:38:21', null, null);
INSERT INTO `b_visit` VALUES ('12260', 'VC', '地方', '地方', '地方', '6', '20', ' 地方', 'ranqisong', '2018-04-09 21:38:55', null, null);
INSERT INTO `b_visit` VALUES ('12261', '辅导班', '地方', ' 地方', '地方', '6', '20', '的', 'ranqisong', '2018-04-09 21:39:36', null, null);
INSERT INTO `b_visit` VALUES ('12262', '发给', '发给', '发给', ' 发过火', '6', '20', ' 发过火', 'ranqisong', '2018-04-09 21:40:34', null, null);
INSERT INTO `b_visit` VALUES ('12263', '想', '想', '想', '想', '6', '20', '想', 'ranqisong', '2018-04-09 21:44:17', null, null);
INSERT INTO `b_visit` VALUES ('12264', '出', '出', '出', '出', '1', '1', '出', 'admin', '2018-04-09 21:47:49', null, null);
INSERT INTO `b_visit` VALUES ('12265', '娟', '学车困难', '123', '大坪医院', '6', '20', '12312123', 'ranqisong', '2018-04-09 21:48:17', '2018-04-09 21:48:28', null);
INSERT INTO `b_visit` VALUES ('12266', '想', '地方', '的', '的', '4', '1', '的', 'jituan', '2018-04-09 21:52:31', null, null);
...
-- ----------------------------
INSERT INTO `qrtz_scheduler_state` VALUES ('quartzScheduler', 'DESKTOP-H4MLN1P1523282213467', '1523282534733', '15000');
...
CREATE TABLE `sys_log` (
  ...
  `gmt_create` datetime DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=267 DEFAULT CHARSET=utf8 COMMENT='系统日志';
...
CREATE TABLE `sys_role` (
  ...
  PRIMARY KEY (`role_id`)
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COMMENT='系统角色';
...
INSERT INTO `sys_role` VALUES ('42', '20', '培训人员', 'guest', '培训人员', '1', '2018-04-09 21:06:18', '2018-04-09 21:30:41');
...
CREATE TABLE `sys_role_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1633 DEFAULT CHARSET=utf8 COMMENT='角色与菜单对应关系';
...
INSERT INTO `sys_role_menu` VALUES ('1627', '42', '1');
INSERT INTO `sys_role_menu` VALUES ('1628', '42', '90');
INSERT INTO `sys_role_menu` VALUES ('1629', '42', '91');
INSERT INTO `sys_role_menu` VALUES ('1630', '42', '92');
INSERT INTO `sys_role_menu` VALUES ('1631', '42', '93');
INSERT INTO `sys_role_menu` VALUES ('1632', '42', '94');
...
CREATE TABLE `sys_role_org` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='角色与机构对应关系';

-- ----------------------------
-- Records of sys_role_org
-- ----------------------------
INSERT INTO `sys_role_org` VALUES ('31', '42', '20');
...
INSERT INTO `sys_user` VALUES ('5', '4', 'xiaoran', '706c728377e459a36c96c29c95d0c44f', '12312', '13456789012', '1', null, '1', '2018-04-09 21:05:00', '2018-04-09 21:06:31');
...
-- ----------------------------
INSERT INTO `sys_user_token` VALUES ('1', '803994faa4af4ec37d670b3663ae7e3f', '2018-04-10 09:55:43', '2018-04-09 21:55:43');
INSERT INTO `sys_user_token` VALUES ('2', '5004cd9815f7b6e8ac8d831af7eb9324', '2017-09-05 04:04:34', '2017-09-04 16:04:34');
INSERT INTO `sys_user_token` VALUES ('4', '7408952d586f36bb0042f1c9481aa86e', '2018-04-10 09:55:01', '2018-04-09 21:55:01');
INSERT INTO `sys_user_token` VALUES ('6', '475dac5bc827203e77a06bfe315f51f8', '2018-04-10 09:50:31', '2018-04-09 21:50:31');
